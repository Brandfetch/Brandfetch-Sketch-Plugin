...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/open.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function(Promise) {var _typeof = __webpack_require__(/*! ./typeof.js */ "./node_modules/@babel/runtime/helpers/typeof.js")["default"];
...
var handleColor = function handleColor(_ref) {
  ...
  if (!selection.isEmpty) {
    selection.forEach(function (layer) {
      layer.style.fills = [{
        color: hexColor,
        fillType: sketch_dom__WEBPACK_IMPORTED_MODULE_0___default.a.Style.FillType.Color
      }];
      layer.style.borders = [{
        enabled: false
      }];
    ...
    sketch__WEBPACK_IMPORTED_MODULE_1___default.a.UI.message("Copied ".concat(hexColor, " to clipboard."));
  }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(fetch) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleFile", function() { return handleFile; });
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils.js */ "./src/handleFile/utils.js");




var allowedFormats = ["jpg", "jpeg", "png", "gif", "svg", "webp"];
var handleFile = /*#__PURE__*/function () {
  var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(_ref) {
    var name, formats, currentFormat, type, file, document, selection, canvasView, center, width, height, x, y;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          name = _ref.name, formats = _ref.formats, currentFormat = _ref.currentFormat, type = _ref.type;
          ...
          sketch__WEBPACK_IMPORTED_MODULE_2___default.a.UI.message("Could not load ".concat(currentFormat, " file. Please make sure the format is supported."));
          return _context.abrupt("return");
        case 5:
          file = formats.find(function (file) {
            return file.format === currentFormat;
          }); // Get Document, from document get page & layers.
          document = sketch__WEBPACK_IMPORTED_MODULE_2___default.a.getSelectedDocument();
          selection = document.selectedLayers;
          if (file.format === "svg") {
            fetch(file.src).then(function (response) {
              return response.text();
            }).then(function (content) {
              return Object(_utils_js__WEBPACK_IMPORTED_MODULE_3__["handleSVG"])({
                name: name,
                content: content
              });
            }).catch(function (err) {
              console.log(err);
              sketch__WEBPACK_IMPORTED_MODULE_2___default.a.UI.message("Something went wrong with this file.");
            });
            if (!selection.isEmpty) {
              sketch__WEBPACK_IMPORTED_MODULE_2___default.a.UI.message("SVG files cannot be inserted into shapes.");
            }
          }
          if (file.format !== "svg") {
            if (!selection.isEmpty) {
              ...
              x = center.x - width / 2;
              y = center.y - height / 2;
              new sketch__WEBPACK_IMPORTED_MODULE_2___default.a.Image({
                name: name,
                image: NSURL.URLWithString(encodeURI(file.src)),
                frame: {
                  x: x,
                ...
                parent: sketch__WEBPACK_IMPORTED_MODULE_2___default.a.getSelectedDocument().selectedPage
              });
            }
          }
        case 10:
...
/*!*********************************!*\
  !*** ./src/handleFile/utils.js ***!
  \*********************************/
/*! exports provided: handleSVG */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleSVG", function() { return handleSVG; });
/* harmony import */ var sketch_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sketch/dom */ "sketch/dom");
/* harmony import */ var sketch_dom__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sketch_dom__WEBPACK_IMPORTED_MODULE_0__);
...
var positionInArtboard = function positionInArtboard(layer, x, y, w, h) {
  ...
  var newFrame = new sketch_dom__WEBPACK_IMPORTED_MODULE_0___default.a.Rectangle(layer.frame);
...
var handleSVG = function handleSVG(_ref) {
  var name = _ref.name,
  ...
  var layer = sketch_dom__WEBPACK_IMPORTED_MODULE_0___default.a.getSelectedDocument().getLayersNamed(name).pop();
  ...
  var width = 220;
  var height = layer.frame.height / layer.frame.width * width;
...
/*!***************************!*\
  !*** ./src/handleFont.js ***!
  \***************************/
/*! exports provided: handleFont */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleFont", function() { return handleFont; });
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sketch */ "sketch");
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sketch__WEBPACK_IMPORTED_MODULE_0__);

var handleFont = function handleFont(_ref) {
    ...
    selection.forEach(function (layer) {
      if (layer.type == "Text") {
        ...
        if (exists) {
          ...
          sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Could not find ".concat(fontFamily, " font in Sketch."));
        }
      }
    });
  } else {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Copied ".concat(fontFamily, " to clipboard."));
  }
};
...
/*!**************************!*\
  !*** ./src/handleURL.js ***!
  \**************************/
/*! exports provided: handleURL */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleURL", function() { return handleURL; });
var handleURL = function handleURL(_ref) {
  var url = _ref.url;
...
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! sketch */ "sketch");
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(sketch__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _handleFile_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./handleFile/index.js */ "./src/handleFile/index.js");
/* harmony import */ var _handleColor_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./handleColor.js */ "./src/handleColor.js");
/* harmony import */ var _handleFont_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./handleFont.js */ "./src/handleFont.js");
/* harmony import */ var _handleURL_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./handleURL.js */ "./src/handleURL.js");
...
var identifier = "brandfetch";
function open() {
  try {
    // Check if window is already opened.
    var win = sketch_module_web_view__WEBPACK_IMPORTED_MODULE_0___default.a.fromId(identifier);
    ...
    win = new sketch_module_web_view__WEBPACK_IMPORTED_MODULE_0___default.a({
    ...
    win.webContents.on("file", function (payload) {
      return Object(_handleFile_index_js__WEBPACK_IMPORTED_MODULE_2__["handleFile"])(payload);
    });
    win.webContents.on("color", function (payload) {
      return Object(_handleColor_js__WEBPACK_IMPORTED_MODULE_3__["handleColor"])(payload);
    });
    win.webContents.on("font", function (payload) {
      return Object(_handleFont_js__WEBPACK_IMPORTED_MODULE_4__["handleFont"])(payload);
    });
    win.webContents.on("open_url", function (payload) {
      return Object(_handleURL_js__WEBPACK_IMPORTED_MODULE_5__["handleURL"])(payload);
    });
  } catch (err) {
    sketch__WEBPACK_IMPORTED_MODULE_1___default.a.UI.message("Something went wrong, check your network connexion.");
  }
}
...
globalThis['open'] = __skpm_run.bind(this, 'open');
globalThis['onRun'] = __skpm_run.bind(this, 'default')

//# sourceMappingURL=__open.js.map